...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#ac421bcc#;
   ...
   u00118 : constant Version_32 := 16#91809229#;
   pragma Export (C, u00118, "ada__real_timeB");
   u00119 : constant Version_32 := 16#1ad7dfc0#;
   pragma Export (C, u00119, "ada__real_timeS");
   u00120 : constant Version_32 := 16#96c62183#;
   pragma Export (C, u00120, "system__taskingB");
   u00121 : constant Version_32 := 16#256a579d#;
   pragma Export (C, u00121, "system__taskingS");
   u00122 : constant Version_32 := 16#0c334715#;
   pragma Export (C, u00122, "system__task_primitivesS");
   u00123 : constant Version_32 := 16#4e3ebb7e#;
   pragma Export (C, u00123, "system__os_interfaceS");
   u00124 : constant Version_32 := 16#0039537b#;
   pragma Export (C, u00124, "interfaces__c__stringsB");
   u00125 : constant Version_32 := 16#eda3d306#;
   pragma Export (C, u00125, "interfaces__c__stringsS");
   u00126 : constant Version_32 := 16#cc709166#;
   pragma Export (C, u00126, "system__task_primitives__operationsB");
   u00127 : constant Version_32 := 16#9723968e#;
   ...
   u00129 : constant Version_32 := 16#cf061228#;
   pragma Export (C, u00129, "system__float_controlS");
   u00130 : constant Version_32 := 16#6387a759#;
   pragma Export (C, u00130, "system__interrupt_managementB");
   u00131 : constant Version_32 := 16#26aedc33#;
   pragma Export (C, u00131, "system__interrupt_managementS");
   u00132 : constant Version_32 := 16#7bca5a8d#;
   pragma Export (C, u00132, "system__multiprocessorsB");
   u00133 : constant Version_32 := 16#1756ce67#;
   pragma Export (C, u00133, "system__multiprocessorsS");
   u00134 : constant Version_32 := 16#24ec69e6#;
   pragma Export (C, u00134, "system__os_primitivesB");
   u00135 : constant Version_32 := 16#280734e2#;
   pragma Export (C, u00135, "system__os_primitivesS");
   u00136 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00136, "system__arith_64B");
   u00137 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00137, "system__arith_64S");
   u00138 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00138, "system__task_lockB");
   u00139 : constant Version_32 := 16#4e70667a#;
   pragma Export (C, u00139, "system__task_lockS");
   u00140 : constant Version_32 := 16#b8c476a4#;
   pragma Export (C, u00140, "system__win32__extS");
   u00141 : constant Version_32 := 16#ce7dfb56#;
   pragma Export (C, u00141, "system__task_infoB");
   u00142 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00142, "system__task_infoS");
   u00143 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00143, "system__tasking__debugB");
   u00144 : constant Version_32 := 16#d3b35c55#;
   ...
   u00150 : constant Version_32 := 16#8d63b971#;
   pragma Export (C, u00150, "system__stack_usageS");
   u00151 : constant Version_32 := 16#d8bb58e0#;
   pragma Export (C, u00151, "ada__text_ioB");
   u00152 : constant Version_32 := 16#1eb2ee39#;
   ...
   u00155 : constant Version_32 := 16#30f1a29e#;
   pragma Export (C, u00155, "system__file_ioB");
   u00156 : constant Version_32 := 16#888bb071#;
   ...
   u00159 : constant Version_32 := 16#2d4c7e6e#;
   pragma Export (C, u00159, "gnat__semaphoresB");
   u00160 : constant Version_32 := 16#03f45b79#;
   pragma Export (C, u00160, "gnat__semaphoresS");
   ...
   u00187 : constant Version_32 := 16#ca8c282d#;
   pragma Export (C, u00187, "system__finalization_mastersB");
   u00188 : constant Version_32 := 16#4e386d0b#;
   ...
   u00190 : constant Version_32 := 16#548cb6a3#;
   pragma Export (C, u00190, "system__storage_poolsS");
   u00191 : constant Version_32 := 16#8e7c94d7#;
   pragma Export (C, u00191, "system__storage_pools__subpoolsB");
   u00192 : constant Version_32 := 16#8393ab70#;
   pragma Export (C, u00192, "system__storage_pools__subpoolsS");
   u00193 : constant Version_32 := 16#cafa918a#;
   pragma Export (C, u00193, "system__storage_pools__subpools__finalizationB");
   u00194 : constant Version_32 := 16#8bd8fdc9#;
   pragma Export (C, u00194, "system__storage_pools__subpools__finalizationS");
   u00195 : constant Version_32 := 16#c9a3fcbc#;
   pragma Export (C, u00195, "system__stream_attributesB");
   u00196 : constant Version_32 := 16#414158da#;
   ...
   u00200 : constant Version_32 := 16#cafa8775#;
   pragma Export (C, u00200, "system__fat_lfltS");
   u00201 : constant Version_32 := 16#b02a299f#;
   pragma Export (C, u00201, "system__fat_llfS");
   u00202 : constant Version_32 := 16#75390335#;
   ...
   u00204 : constant Version_32 := 16#ead5bc8c#;
   pragma Export (C, u00204, "system__tasking__stagesB");
   u00205 : constant Version_32 := 16#6153a6f3#;
   pragma Export (C, u00205, "system__tasking__stagesS");
   u00206 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00206, "system__memoryB");
   u00207 : constant Version_32 := 16#76873720#;
